...
- the startup overlay now clears as soon as `system` is ready; market analysis continues in the background so startup latency is no longer coupled to the heaviest market fetch
