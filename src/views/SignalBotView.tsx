        ...
        <div className="signalbot-panel card">
              ...
              <SectionCard title="Execution Intent" subtitle="What this bot is currently allowed to escalate toward execution." className="signalbot-subcard">
                <div className="signalbot-mini-grid">
                  ...
                  <MetricTile
                    ...
                    note={`${feedReadModel.selectedBotExecutionIntentSummary?.dispatchRequestedCount || 0} dispatch requested • ${feedReadModel.selectedBotExecutionIntentSummary?.linkedCount || 0} already linked to execution.`}
                  />
                  <MetricTile
          ...
          {activeTab === "settings" ? (
            <div className="signalbot-settings-grid">
              ...
              <SettingsCard title="Execution Intent" value={`${formatExecutionIntentStatus(feedReadModel.selectedBotExecutionIntentSummary?.latestIntentStatus)} • ${String(feedReadModel.selectedBotExecutionIntentSummary?.queuedCount || 0)} queued`} note={feedReadModel.selectedBotExecutionIntentSummary?.latestGuardrailCode ? `Last block: ${feedReadModel.selectedBotExecutionIntentSummary.latestGuardrailCode}` : `${feedReadModel.selectedBotExecutionIntentSummary?.dispatchRequestedCount || 0} dispatch requested • lane ${formatExecutionIntentLaneStatus(feedReadModel.selectedBotExecutionIntentSummary?.latestLaneStatus)}`} />
