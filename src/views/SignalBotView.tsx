        ...
        <div className="signalbot-panel card">
            ...
            <div className="signalbot-performance-grid">
              ...
              <SectionCard title="Execution Intent" subtitle="What this bot is currently allowed to escalate toward execution." className="signalbot-subcard">
                <div className="signalbot-mini-grid">
                  ...
                  <MetricTile
                    label="Paper / Demo"
                    value={`${String(feedReadModel.selectedBotExecutionIntentSummary?.previewedCount || 0)} / ${String(feedReadModel.selectedBotExecutionIntentSummary?.executionSubmittedCount || 0)}`}
          ...
          {activeTab === "settings" ? (
            <div className="signalbot-settings-grid">
              ...
              <SettingsCard title="Execution Intent" value={`${formatExecutionIntentStatus(feedReadModel.selectedBotExecutionIntentSummary?.latestIntentStatus)} • ${String(feedReadModel.selectedBotExecutionIntentSummary?.queuedCount || 0)} queued`} note={feedReadModel.selectedBotExecutionIntentSummary?.latestGuardrailCode ? `Last block: ${feedReadModel.selectedBotExecutionIntentSummary.latestGuardrailCode}` : `${feedReadModel.selectedBotExecutionIntentSummary?.dispatchRequestedCount || 0} dispatch requested • ${feedReadModel.selectedBotExecutionIntentSummary?.previewedCount || 0} previewed • ${feedReadModel.selectedBotExecutionIntentSummary?.executionSubmittedCount || 0} demo submitted • ${buildLatestDispatchNote(selectedBotCard)}`} />
