...
export function SignalsView() {
  ...
  const readModel = useMemo(() => {
    ...
    return {
      ...
      priority: core.signalCore.taxonomy.operable,
      observational: core.signalCore.taxonomy.observational,
      informational: core.signalCore.taxonomy.informational,
      aiPrioritized: core.signalCore.taxonomy.aiPrioritized,
